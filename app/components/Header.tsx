...
const Header = () => {
    ...
    return (
        <>
            <header className="bg-background/200 backdrop-blur-md border-b border-church-gold/40 dark:border-church-gold/60 py-2 sm:py-3 transition-colors duration-300 sticky top-0 z-50">
